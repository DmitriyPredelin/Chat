export const SeeBarkIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 150 20 20" height="40px" viewBox="0 0 20 20" width="40px" fill="rgb(23, 207, 189)">
